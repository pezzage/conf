...
user="peeter" #Username for new install.
PASSWORD="123" #Password for user in new install.
hostname="" #Name to identify the main system on the network. An underscore is DNS non-compliant.
...
extra_programs(){
	...
	yes)	
		...
		apt install -y man-db tldr plocate git vim
